...
§6 (PH venue fit & significance) and §4 (equity significance). Weigh
**population relevance, policy/practice actionability, and equity impact**
alongside novelty, and calibrate the venue tier to the manuscript's scope and
rigor without inventing a specific editor's preferences. Watch for
**evidence–claim mismatch** (§2): flag when the Abstract/Discussion upgrades an
association to a causal or policy claim the design cannot support.
