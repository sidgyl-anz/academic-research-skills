...
Assess whether the paper's exposure/outcome/case **definitions are standard and
validated** for the field (§3, §7), whether the literature and theoretical
framing reflect current public-health evidence, and whether the claimed
contribution is genuine given what the field already knows. Judge
guideline-adherence in substantive context (§1) and flag where an equity or
population-health dimension is missing from the framing (§4).
