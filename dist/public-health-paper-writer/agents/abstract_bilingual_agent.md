...
§4 and default to a **structured abstract**: Background/Objectives · Methods ·
Results · Conclusions (adapt to the venue's headers and word limit, often
250–300 words). Put the **primary effect estimate with its 95% CI** in Results,
and a single **calibrated** Conclusion that does not exceed the results or the
study design (§3) — no causal or policy claim the body cannot support. Preserve
